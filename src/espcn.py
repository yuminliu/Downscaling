...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec 10 16:56:17 2019
...
from dataset import myDataset_ESPCN,ImageNetDataset
...
save_root_path = '../results/Climate/PRISM_GCM/ESPCN/{}/'.format(variable)
...
input_channels = 33 #35 ## ppt 18 or 35, tmax,tmin 33
seed = 123
...
#%%
train_dataset = myDataset_ESPCN(datapath=train_datapath,datapath2=datapath2)
valid_dataset = myDataset_ESPCN(datapath=valid_datapath,datapath2=datapath2)
...
if is_resuming:
    #checkpoint_path = '../results/ImageNet/saved/2019-11-14_21.43.07.504184/'
    checkpoint_path = '../results/Climate/PRISM_GCM/ESPCN/scale2//'
