...
from models import YNet30_test
...
save_root_path = '../results/Climate/PRISM_GCM/YNet30/{}/'.format(variable)
...
#%%
model = YNet30_test(input_channels=input_channels,output_channels=1,scale=scale,use_climatology=use_climatology)
...
#train_losses, valid_losses = [], []
#%% create save path 
savepath = checkpoint_path if (is_resuming and checkpoint_path and not is_transfer) else create_savepath(rootpath=save_root_path,is_debug=is_debug)
#if is_resuming:
