...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan  7 17:33:56 2020
...
def collect_GCM():
    ...
    savepath = '/home/yumin/myProgramFiles/DATA/GCM/GCMdata/ppt/35channels/rawdata/pr/'
...
def readGCM():
    ...
    filepath = prefix+'GCM/GCMdata/ppt/35channels/rawdata/'+variablename+'/'
    savepath0 = prefix+'GCM/GCMdata/ppt/35channels/processeddata_26by59_points/'
...
def readElevation():
    ...
    datapath = prefix+'PRISM/PRISMdata/elevation/raw/wcs_4km_prism.nc'
    savepath = prefix+'PRISM/PRISMdata/elevation/processeddata/' #None
...
def downsamplePRISM():
    ...
    datapath = prefix+'PRISM/PRISMdata/ppt/processeddata/prism_prmean_monthly_0.04by0.04_original_grid/'
    savepath = prefix+'PRISM/PRISMdata/ppt/processeddata/'
...
def mergexy(resolution='0.125'):
    ...
    prefix = '/home/yumin/Desktop/DS/DATA/'
    #prefix = '/scratch/wang.zife/YuminLiu/'
    climatologypath = '../data/Climate/PRISM_GCMdata/ppt/35channels/prism_gcm_log1p_prmean_monthly_{}by{}_195001-199912_USA_month_1to600.npy'.format(resolution,resolution)
    gcmpath = prefix+'GCM/GCMdata/ppt/35channels/processeddata_26by59_points/35gcms_prmean_monthly_1by1_195001-200512_USA.npy'
    #resolution = '0.5'
    prismpath = prefix+'PRISM/PRISMdata/ppt/processeddata/prism_prmean_monthly_{}by{}/'.format(resolution,resolution)
    ...
    savepath = '../data/Climate/PRISM_GCMdata/ppt/35channels/{}by{}/'.format(resolution,resolution)
    #if savepath and not os.path.exists(savepath):
    #    os.makedirs(savepath)
    ...
    for mon in range(prismdata.shape[0]):
        ...
        if mon<600:
            ...
            folder = 'test/'
        if savepath and not os.path.exists(savepath+folder):
            os.makedirs(savepath+folder)
        #np.savez(savepath+savename+'.npz',gcms=gcms,prism=prism)
        np.savez(savepath+folder+savename+'.npz',gcms=gcms,prism=prism,elevation=elevation,climatology=climatology)
        # if mon==0:
        #     fig = plt.figure()
